       ...
       appBar: AppBar(
        ...
        centerTitle: true,
         title: const Text(
          ...
          fontSize: 21,decoration: TextDecoration.underline,color:  Color.fromRGBO(37, 43, 103, 1),),
          ),
          leading:const Center(
            child: Padding(
              padding: EdgeInsets.all(10.0),
              child: CircleAvatar(
               backgroundImage: AssetImage('img7.jpg')
        ),
            )),
         actions: [
          PopupMenuButton<String>(
              icon: const Icon(Icons.menu,color: Color.fromRGBO(37, 43, 103, 1),),
              onSelected: (value) {
                setState(() {
                  selectedItem = value;
                });
         ...
         IconButton(onPressed: () {}, icon: const Icon(Icons.search,color: Color.fromRGBO(37, 43, 103, 1))),
